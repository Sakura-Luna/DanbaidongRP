<div align="center">
<img src="https://img.shields.io/badge/Unity ver-6000.2.0f1-red"/>
...
* Create a new Unity 6 URP project <span style="color: #FF8C00;">(6000.2.0f1)</span>.
* *Window -> Package Manager*, remove *Universal RP* and delete the contents of the *Assets/Settings* folder.
* Add *DanbaidongRP* through the *Package Manager*. It is recommended to use the "Install package from disk..." option to individually add the [Core](https://github.com/Sakura-Luna/DanbaidongRPCore), [Config](https://github.com/Sakura-Luna/DanbaidongRPConfig), and [DanbaidongRP](https://github.com/Sakura-Luna/DanbaidongRP) packages (select the `package.json` file for each).
